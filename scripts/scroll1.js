...
window.addEventListener('scroll',()=>{
    //스크롤 위치에 따라 section이 화면 중앙보다 더 위로 올라오면
    //각 섹션(4)의 제목 aside(4) 색상이 active로 활성트
    for(let s of section){
        ...
        //화면 상단(0) 기준
        //섹션의 윗(top) 부분이 화면 위에서 150px 지점보다 같거나 더 위로 올라와있다면 조건문 실행
        if(sTop <= 150){
