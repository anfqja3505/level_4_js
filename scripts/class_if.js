...
like_btn.addEventListener('click',()=>{
    like_btn.classList.toggle('like_click')
})
...
//인쇄 버튼 클릭 시 -> 인쇄하시겠습니까? 질문 -> 확인(예) 클릭 시 인쇄 실행
//인쇄 버튼 클릭 시 -> 인쇄하시겠습니까? 질문 -> 취소(아니오) 클릭 시 실행 안함
