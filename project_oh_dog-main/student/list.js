...
//select 태그 변수를 이벤트를 제작 시 사용해야하는 이벤트 종류 : change
// colorSelect.addEventListener('change',()=>{
//     if(colorSelect.selectedIndex > 0) { //첫번째(0) 안내문을 제외
//         //console.log('change 변경확인')
...
//         //선택 색상 옵션이 opt_result의 result자식에 "색상 :" 자리에 삽입하기
//         showHideFunc(optResult, 'flex');
